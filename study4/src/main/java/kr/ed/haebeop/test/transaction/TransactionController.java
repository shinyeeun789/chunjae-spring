...
public class TransactionController {
    ...
    //http:localhost:8088/study4_war/transaction/addCollection
    //http:localhost:8088/study4_war/test/addCollection.jsp
    ...
    public String addCollectionPro(TransVO vo, Model model){
